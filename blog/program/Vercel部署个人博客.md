...
image: https://img.wenhao.cn/image-20220511170700075.png
---

![image-20220511170700075](https://img.wenhao.cn/image-20220511170700075.png)
...
![image-20220511170233559](https://img.wenhao.cn/image-20220511170233559.png)

点击 [New Project](https://vercel.com/new)

![image-20220511165902993](https://img.wenhao.cn/image-20220511165902993.png)

这里可以从已有的 git repository 中导入，也可以选择一个模板。

这里登录我的 Github 账号选择仓库，然后点击 blog 仓库旁的 Import 即可。当然，你也可以直接拉取我的仓库，仓库地址：[wenhao/blog](https://github.com/wenhao/blog)

![image-20220511165513526](https://img.wenhao.cn/image-20220511165513526.png)
...
![image-20220511171144240](https://img.wenhao.cn/image-20220511171144240.png)

接着提示域名需要 DNS 解析到 vercel 提供的记录值

![image-20220511171359148](https://img.wenhao.cn/image-20220511171359148.png)

登录所在的域名服务商，根据 Vercel 提供的记录值 cname.vercel-dns.com，添加两条记录

![image-20220511172741663](https://img.wenhao.cn/image-20220511172741663.png)

此时回到 Vercel，可以看到记录值成功生效。

![image-20220511172027570](https://img.wenhao.cn/image-20220511172027570.png)
...
![image-20220511172240999](https://img.wenhao.cn/image-20220511172240999.png)
...
![image-20220511173442694](https://img.wenhao.cn/image-20220511173442694.png)
...
🔗  Linked to wenhao12/online-tools (created .vercel and added it to .gitignore)
🔍  Inspect: https://vercel.com/wenhao12/online-tools/6t8Vt8rG3waGVHTKU7ZzJuGc6Hoq [2s]
✅  Production: https://online-tools-phi.vercel.app [copied to clipboard] [2m]
📝  Deployed to production. Run `vercel --prod` to overwrite later (https://vercel.link/2F).
💡  To change the domain or build command, go to https://vercel.com/wenhao12/online-tools/settings
```
