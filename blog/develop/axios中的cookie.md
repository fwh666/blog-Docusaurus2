...
instance.interceptors.request.use((config) => {
  config.headers['cookie'] = 'cookie=this_is_cookies;username=wenhao;'
...
![image-20201210060704240](https://img.wenhao.cn/image-20201210060704240.png)
...
![image-20201210061627824](https://img.wenhao.cn/image-20201210061627824.png)
...
function test() {
  ...
  let headers = {};
  let cookies = 'username=wenhao;uid=123;';
...
Cookie: username=wenhao;uid=123;
...
![image-20201210214055696](https://img.wenhao.cn/image-20201210214055696.png)
