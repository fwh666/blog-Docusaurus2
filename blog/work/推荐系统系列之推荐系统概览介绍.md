...
- 推荐系统的应用场景
  ...
  ![img](https://img.fuwenhao.club/blog/recommend1.png)
...
- 推荐系统整体架构
  ...
  ![img](https://img.fuwenhao.club/blog/%E6%8E%A8%E8%8D%90%E6%B5%81%E7%A8%8B.png)
...
- 大数据Lambda架构
  ...
  - Lambda架构图
    ...
    ![img](https://img.fuwenhao.club/blog/lambda3.png)
...
![img](https://img.fuwenhao.club/blog/recommend7.jpeg)
...
- 特征工程
  ...
  - 从数据中筛选特征
    ...
    - 使用用户行为数据描述商品
      ...
      ![img](https://img.fuwenhao.club/blog/algorithm3.png)

  - 用数据表示特征

    - 将所有用户行为合并在一起 ，形成一个user-item 矩阵

      ![1545452707102](https://img.fuwenhao.club/blog/algorithm4.png)
...
![img](https://img.fuwenhao.club/blog/%E5%9F%BA%E4%BA%8E%E7%94%A8%E6%88%B7%E7%9A%84%E5%8D%8F%E5%90%8C%E8%BF%87%E6%BB%A4%E6%8E%A8%E8%8D%901.png)

Item-Based CF

![img](https://img.fuwenhao.club/blog/%E5%9F%BA%E4%BA%8E%E7%89%A9%E5%93%81%E7%9A%84%E5%8D%8F%E5%90%8C%E8%BF%87%E6%BB%A4%E6%8E%A8%E8%8D%901.png)

### 3 相似度计算(Similarity Calculation)

![img](https://img.fuwenhao.club/blog/similarity_calc1.png)

- 相似度的计算方法

  - 欧氏距离, 是一个欧式空间下度量距离的方法. 两个物体, 都在同一个空间下表示为两个点, 假如叫做p,q, 分别都是n个坐标, 那么欧式距离就是衡量这两个点之间的距离. 欧氏距离不适用于布尔向量之间

  ![1546159024305](https://img.fuwenhao.club/blog/od.png)

   欧氏距离的值是一个非负数, 最大值正无穷, 通常计算相似度的结果希望是[-1,1]或[0,1]之间,一般可以使用

   如下转化公式:![img](https://img.fuwenhao.club/blog/od2.png)
  ...
  - 余弦相似度
    ...
    ![img](https://img.fuwenhao.club/blog/cosine.png)

    ![img](https://img.fuwenhao.club/blog/similarity_calc5.png)
...
- 皮尔逊相关系数Pearson
  ...
  ![img](https://img.fuwenhao.club/blog/pearson.png)
...
- 杰卡德相似度 Jaccard
  ...
  ![img](https://img.fuwenhao.club/blog/jaccard.png)
...
- 稠密评分矩阵
  ...
  ![img](https://img.fuwenhao.club/blog/%E7%A8%A0%E5%AF%86%E8%AF%84%E5%88%86%E6%95%B0%E6%8D%AE%E9%9B%86.png)

- 稀疏评分矩阵

  ![img](https://img.fuwenhao.club/blog/%E7%A8%80%E7%96%8F%E8%AF%84%E5%88%86%E6%95%B0%E6%8D%AE%E9%9B%86.png)

这里先介绍稠密评分矩阵的处理，稀疏矩阵的处理相对会复杂一些，我们到后面再来介绍。

#### 使用协同过滤推荐算法对用户进行评分预测

- 数据集：![img](https://img.fuwenhao.club/blog/%E7%A8%A0%E5%AF%86%E8%AF%84%E5%88%86%E6%95%B0%E6%8D%AE%E9%9B%86.png)
...
![img](https://img.fuwenhao.club/blog/recommend2.png)
...
- 常用评估指标
  ...
  - 准确性 (理论角度)
    ...
    - 评分预测
      ...
      - RMSE （均方根误差）
        ...
        ![img](https://img.fuwenhao.club/blog/rmse.webp)

      - MAE (平均绝对误差)

        ![img](https://img.fuwenhao.club/blog/mae.webp)
  ...
  ![img](https://img.fuwenhao.club/blog/recommend3.png)
...
- 用户冷启动：尽可能收集用户特征数据
  ...
  - 2 引导用户填写兴趣
    ...
    ![img](https://img.fuwenhao.club/blog/recommend5.png)

  - 3 使用其它站点/应用的行为数据, 例如腾讯视频&QQ音乐

    ![img](https://img.fuwenhao.club/blog/recommend4.png)
...
- 物品冷启动
  ...
  ![img](https://img.fuwenhao.club/blog/firststart2.png)
