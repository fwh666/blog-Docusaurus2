...
```sh
adb push C:\Users\wenhao\Desktop\frida-server-15.1.14-android-arm64 /data/local/tmp/fsarm64
...
let Utils = Java.use('com.wenhao.app.Utils')
```
...
```javascript
const Utils = Java.use('com.wenhao.app.Utils')
...
var Person = Java.use('com.wenhao.app.Person')
var person = Person.$new('wenhao', 20)
...
```
adb push C:\Users\wenhao\Desktop\frida-inject-15.1.14-android-arm64 /data/local/tmp/fiarm64
