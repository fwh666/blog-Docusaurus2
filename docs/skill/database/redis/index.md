...
############################################################################
# 对象
set user:1 {name:wenhao,age:20} # 设置user为一个对象
# or
set user:1:name wenhao
# user:{id}:{filed} value
...
![查看源图像](http://cdn.wenhao.cn/blogR50ea35ec36a3e4ea16cb132637477df0)
...
![img](http://cdn.wenhao.cn/blog11320039-57a77ca2757d0924.png)
