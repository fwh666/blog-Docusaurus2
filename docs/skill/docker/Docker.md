...
![](https://img.wenhao.cn/image-20210527011655512.png)

## Docker 的命令

![](https://img.wenhao.cn/v2-820aee2a33654099d87cdd2b7a1ce741_r.jpg)
...
![](https://img.wenhao.cn/OIP.p3NmHHlewBvLwukFPGudFgHaFV.jpg)
...
```dockerfile
FROM cetnos
MAINTAINER wenhao<911993023@qq.com>
...
2、docker login -u wenhao

3、输入密码

```
[root@localhost ~]# docker login -u wenhao
Password:
