...
![image-20210912080353288](https://img.wenhao.cn/image-20210912080353288.png)

突然想到貌似 vue-element-admin 中的路由好像也是这样的，而 store 貌似定义完就无需再次导入，于是就开始研究代码，果不其然，发现了`require.context`

![image-20210912080429237](https://img.wenhao.cn/image-20210912080429237.png)
...
![image-20210912081146031](https://img.wenhao.cn/image-20210912081146031.png)
...
![image-20210912081553729](https://img.wenhao.cn/image-20210912081553729.png)
