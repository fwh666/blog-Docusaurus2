...
本博客已经内置好评论组件 [src/component/Comment](https://github.com/wenhao/blog/blob/main/src/components/Comment/index.tsx)，所以只需要在 `docusaurus.config.js` 中设置 giscus 的配置即可。
