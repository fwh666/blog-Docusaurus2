...
![vscode上号](https://img.wenhao.cn/vscode%E4%B8%8A%E5%8F%B7.jpg)

看一大堆vscode相关推荐，不如直接把别人的vscode配置直接导入到本地上运行测试。
以下是我的 Vscode 全部配置文件，需要的可自行下载导入（替换本地 vscode 相对应的配置文件即可）。

> 下载地址 https://pan.wenhao.cn/s/RgiP 密码 wenhao
...
![image-20210817213845020](https://img.wenhao.cn/image-20210817213845020.png)
...
![image-20220610012923130](https://img.wenhao.cn/image-20220610012923130.png)
...
![image-20210817221312429](https://img.wenhao.cn/image-20210817221312429.png)
...
![image-20221003223247386](https://img.wenhao.cn/image-20221003223247386.png)
...
![image-20220610013640476](https://img.wenhao.cn/image-20220610013640476.png)
...
![image-20200901212906150](https://img.wenhao.cn/image-20200901212906150.png)
...
![image-20200901214223439](https://img.wenhao.cn/image-20200901214223439.png)
...
![image-20200901214906038](https://img.wenhao.cn/image-20200901214906038.png)

在比如有的库安装会没带代码提示，这时候就用上面的方法同样也可以有代码提示，例如`express`

`express`相关安装操作我就不赘述了，先看图片

![image-20200901215612611](https://img.wenhao.cn/image-20200901215612611.png)

这 app 代码提示怎么全是 js 自带的代码提示。

然后在看`node_modules\@types`下，怎么只有我刚刚安装的那几个？

![image-20200901215826419](https://img.wenhao.cn/image-20200901215826419.png)
...
![image-20200901220225659](https://img.wenhao.cn/image-20200901220225659.png)

果不其然，`vscode`里也有正常的代码提示了

![image-20200901220329481](https://img.wenhao.cn/image-20200901220329481.png)
...
1. 创建一个.vscode 文件夹，在文件夹里创建一个名为`wenhao.code-snippets`（只要后缀是 code-snippets 就行）
2. 在这个文件内写上如下代码
